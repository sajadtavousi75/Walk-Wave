...
export default function ProductBox(data) {
  ...
  return (
    ...
    <div className='ProductBox group  w-[160px] h-[160px] sm:w-[220px] sm:h-[220px] xl:w-[250px] xl:h-[250px] rounded-[50px] bg-box hover:shadow-lg transition-all duration-700 ease-in-out relative flex items-center justify-center '>
        ...
        height={250}
        alt='image1'
        className=' absolute group-hover:scale-[0.2] group-hover:invisible group-hover:opacity-0 transition-all duration-700 ease-in-out w-[120px] h-[120px] sm:w-[220px] sm:h-[220px] xl:w-[250px] xl:h-[250px] rounded-[50px] rounded-[50px] object-cover'
        />
        ...
        height={250}
        alt='image2'
        className='scale-[0.2] invisible opacity-0 absolute group-hover:scale-[1] group-hover:visible group-hover:opacity-100 transition-all duration-700 ease-in-out w-[120px] h-[120px] sm:w-[220px] sm:h-[220px] xl:w-[250px] xl:h-[250px] rounded-[50px] rounded-[50px] object-cover '
        />
    </div>
    </Link>
  )
