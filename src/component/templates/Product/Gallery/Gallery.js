      ...
      <div className="right-gallery w-[100%] ">
        ...
        <div className="reviews bg-secondary1/10 min-h-[135px] rounded-[24px] p-4">
          <div className="top flex items-center justify-between">
            ...
            <div className="write bg-primary1 rounded-lg  p-2  h-[230px]">
              <div className="content flex flex-col items-center justify-center">
              <h1 className="text-center font-kohol">Write a Review</h1>
              <textarea className="w-[90%]  h-[80px] bg-secondary1/10 mt-2 outline-none rounded-[20px] p-2 font-kohol "></textarea>
