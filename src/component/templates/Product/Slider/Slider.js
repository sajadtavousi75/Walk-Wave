  ...
  return (
    ...
    {data.product.cover3.length? (
        ...
        <div onMouseEnter={()=>{
            ...
            <img className='object-cover h-[100%] w-[100%]' src={`https://walkwave-project.liara.run/uploads/${data.product.cover3[0]}`} alt="" />
        ...
        <div onMouseEnter={()=>{
            ...
            <img className='object-cover h-[100%] w-[100%]' src={`https://walkwave-project.liara.run/uploads/${data.product.cover3[1]}`} alt="" />
