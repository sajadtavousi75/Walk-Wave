      ...
      >
        <div className="content container">
          <div
            ...
            className="filter w-[120px] pt-[10px] flex items-center justify-start gap-2"
          >
            {showFilterMobile ? (
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <g clipPath="url(#clip0_1427_2634)">
                  <g clipPath="url(#clip1_1427_2634)">
                    <path
          ...
          <div
            className={` transition-all duration-700 ease-in-out filter-content grid grid-cols-2`}
          >
            <div className="filter-left">
              ...
              <div className="category mt-2">
                <ul className="font-kohol w-[55px]">
                  {["ALL", "lifestyle", "running", "football"].map(
                    (item, index) => (
                      <li
                      key={index}
                        onClick={(event) => {
            ...
            <div className="filter-right">
              <div className="price w-[150px] mt-4">
                <div className="title flex items-center justify-start gap-4">
                  <h1 className="font-kohob">Price Range</h1>
                  <svg
                    className={`${
